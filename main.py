...
def putwindow():
    ...
    tkinter.Label(window, text='- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -',
                  bg='#A7AEB5').pack(fill='x')
    tkinter.Label(window, text="WELCOME TO AUTOMATIC ATTENDANCE", font=(
        "Poppins", 20), fg="black", bg="#A7AEB5").pack(fill="x")
    tkinter.Label(window, text='- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -',
                  bg='#A7AEB5').pack(fill='x')

    tkinter.Label(window, text="GUIDELINES TO USE THIS SOFTWARE",
                  font=18, fg="black", bg="#A7AEB5").pack(fill="x")
    ...
    btn1 = tkinter.Button(window, text="CONTINUE",
                          fg="white", bg='#343B42', command=cont_inue)
...
def show():
    ...
    tkinter.Label(window2, text="WELCOME TO AUTOMATIC ATTENDANCE", font=(
        "Poppins", 20), fg="black", bg="#A7AEB5").pack(fill="x")
    tkinter.Label(window2, text='- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -', bg='#A7AEB5').pack(fill='x')
    ...
    btn1 = tkinter.Button(window2, text="CREATE",
                          fg="white", bg='#343B42', command=create)
    btn1.place(x=255, y=320, width=70)

    btn2 = tkinter.Button(window2, text="TRAIN",
                          fg="white", bg='#343B42', command=train)
    btn2.place(x=360, y=320, width=70)

    btn3 = tkinter.Button(window2, text="ABSENSI",
                          fg="white", bg='#343B42', command=absensi)
    btn3.place(x=470, y=320, width=70)

    btn4 = tkinter.Button(window2, text="EXIT", fg="black",
                          bg='#A6A6A7', command=s_exit)
...
def show_create():
    ...
    tkinter.Label(window3, text="CREATE NEW DATASET", font=(
        "Poppins", 20), fg="black", bg="#A7AEB5").pack(fill="x")
    tkinter.Label(window3, text="\n\n ", bg="black").pack(fill='y')

    tkinter.Label(window3, text="\n\n ", bg="black").pack(fill='y')

    tkinter.Label(window3, text="Masukkan Nama : ", fg="white",
                  bg="#20262C").place(x=100, y=70, width=600)
    inpNama = tkinter.Entry(window3)
    inpNama.place(x=100, y=90, width=600)

    tkinter.Label(window3, text="Masukkan Nim : ", fg="white",
                  bg="#20262C").place(x=100, y=120, width=600)
    inpNim = tkinter.Entry(window3)
    inpNim.place(x=100, y=140, width=600)

    tkinter.Label(window3, text="Masukkan Kelas : ", fg="white",
                  bg="#20262C").place(x=100, y=170, width=600)
    ...
    btn5 = tkinter.Button(window3, text="CONTINUE",
                          fg="white", bg='#343B42', command=submit)
    btn5.place(x=250, y=250, width=90)

    btn6 = tkinter.Button(window3, text="HOME", fg="white",
                          bg='#343B42', command=home)
